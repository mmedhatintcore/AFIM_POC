...
class FundSeeder extends Seeder
{
    ...
    private function seedFunds(): void
    {
        $funds = [
            ...
            ['slug' => 'nbe-fixed-income-fund', 'group_key' => 'mixed', 'order_channel' => 'nbe', 'risk_level' => 0,
                'illustration' => 'fixedincome', 'is_featured' => true, 'sort' => 2,
                'name' => ['en' => 'NBE Fixed-Income Fund', 'ar' => 'صندوق البنك الأهلي للدخل الثابت'],
                'category_label' => ['en' => 'Fixed Income', 'ar' => 'دخل ثابت'],
            ...
            ['slug' => 'nbe-4', 'group_key' => 'mm', 'order_channel' => 'afim', 'risk_level' => 0, 'illustration' => 'moneymarket', 'sort' => 10,
            ...
            ['slug' => 'wethaq', 'group_key' => 'mm', 'order_channel' => 'afim', 'risk_level' => 0, 'illustration' => 'moneymarket', 'sort' => 11,
                'name' => ['en' => 'Wethaq', 'ar' => 'وثاق'],
                'category_label' => ['en' => 'Money Market', 'ar' => 'سوق النقد'],
                'platforms' => $this->platforms(['Ahly Pharos', 'Mubasher', 'Banque Du Caire'])],
            ['slug' => 'horas', 'group_key' => 'mm', 'order_channel' => 'afim', 'risk_level' => 0, 'illustration' => 'moneymarket', 'sort' => 12,
                'name' => ['en' => 'Horas', 'ar' => 'حورس'],
                'category_label' => ['en' => 'Money Market', 'ar' => 'سوق النقد'],
                'platforms' => $this->platforms(['Ahly Pharos', 'Mubasher', 'Banque Du Caire'])],
            ['slug' => 'tamayouz', 'group_key' => 'mm', 'order_channel' => 'afim', 'risk_level' => 0, 'illustration' => 'moneymarket', 'sort' => 13,
                'name' => ['en' => 'Tamayouz', 'ar' => 'تميّز'],
                'category_label' => ['en' => 'Money Market', 'ar' => 'سوق النقد'],
                'platforms' => $this->platforms(['Ahly Pharos', 'Mubasher', 'Banque Du Caire', 'Thndr', 'PFI'])],
            ['slug' => 'islamic-money-market-fund', 'group_key' => 'imm', 'order_channel' => 'afim', 'risk_level' => 0, 'illustration' => 'islamic', 'sort' => 14,
                'name' => ['en' => 'Islamic Money Market Fund', 'ar' => 'الصندوق النقدي الإسلامي'],
